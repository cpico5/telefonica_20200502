...
public class Nombre  {
    ...
    public static final String encuesta = "telefonica_20200502";
    ...
    public String nombreEncuesta(){
        ...
        final String nombreEncuesta = "telefonica_20200502";
        return nombreEncuesta;
    }

    public String nombreDatos(){

        final String nombreEncuesta = "datos_telefonica_20200502";
        return nombreEncuesta;
    }
